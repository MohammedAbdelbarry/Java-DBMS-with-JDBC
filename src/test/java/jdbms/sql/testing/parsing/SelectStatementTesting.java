...
public class SelectStatementTesting {
    ...
    public void testSelectAllConditional() {
        ...
        assertEquals(name, select.getParameters().getTableName());
        assertEquals(cols, select.getParameters().getColumns());
        assertEquals("CustomerID", select.getParameters().getCondition()
                .getLeftOperand());
        assertEquals("1", select.getParameters().getCondition()
                .getRightOperand());
    }

    @Test
    public void testFloatSelectAllConditional() {
        String sqlCommand = "SELECT * FROM Customers WHERE CustomerCoolness "
                + ">= 1.512256;";
        sqlCommand = normalizer.normalizeCommand(sqlCommand);
        final String name = "Customers";
        final ArrayList<String> cols = new ArrayList<>();
        ...
        assertEquals(name, select.getParameters().getTableName());
        assertEquals(cols, select.getParameters().getColumns());
        assertEquals("CustomerCoolness", select.getParameters().getCondition
                ().getLeftOperand());
        assertEquals("1.512256", select.getParameters().getCondition()
                .getRightOperand());
    }
    ...
    public void SelectAllOrderBy() {
        String sqlCommand = "SELECT * FROM Customers WHERE CustomerCoolness "
                + "!= 1.512256 Order By col1, col2, col3 DESC;";
        sqlCommand = normalizer.normalizeCommand(sqlCommand);
        final String name = "Customers";
        final ArrayList<String> cols = new ArrayList<>();
        cols.add("*");
    ...
    public void testSelectConditionalVarchar() {
        String sqlCommand = "SELECT CustomerID,CustomerName FROM Customers "
        ...
        assertEquals(name, select.getParameters().getTableName());
        assertEquals(cols, select.getParameters().getColumns());
        assertEquals("Country", select.getParameters().getCondition()
                .getLeftOperand());
        assertEquals("\"Germany\"", select.getParameters().getCondition()
                .getRightOperand());
    }
    ...
    public void testSelectConditionalInt() {
        ...
        assertEquals("id", select.getParameters().getCondition()
                .getLeftOperand());
        assertEquals("447", select.getParameters().getCondition()
                .getRightOperand());
    ...
    public void testSelectDistinct() {
        String sqlCommand = "SELECT DISTINCT column_name1,column_name2 FROM "
                + "table_name;";
        sqlCommand = normalizer.normalizeCommand(sqlCommand);
        final String name = "table_name";
    ...
    public void testOrderBy() {
        String sqlCommand = "SELECT coll2, col4, hi_man FROM table_name orDer"
                + " BY col1 ASC, col2, col3 DESC, col4 ASC;";
        sqlCommand = normalizer.normalizeCommand(sqlCommand);
        final String name = "table_name";
        final ArrayList<String> list = new ArrayList<>();
        list.add("coll2");
    ...
    public void testSelectColListOrderBy() {
        String sqlCommand = "SELECT col1, col2, hi_man FROM table_name where "
                + "col1 != \"FROM\" orDer BY col1 ASC, col2, col3 DESC, col4 "
                + "ASC;";
        sqlCommand = normalizer.normalizeCommand(sqlCommand);
        final String name = "table_name";
        final ArrayList<String> list = new ArrayList<>();
        ...
        assertEquals(list, select.getParameters().getColumns());
        assertEquals(myOrderList, select.getParameters().getColumnsOrder());
        assertEquals("col1", select.getParameters().getCondition()
                .getLeftOperand());
        assertEquals("\"FROM\"", select.getParameters().getCondition()
                .getRightOperand());
    }
    ...
    public void testInvalidSelectConditionalVarchar() {
        String sqlCommand = "SELECT CustomerID,CustomerName Customers WHERE "
                + "Country = \"Germany\" ;";
        sqlCommand = normalizer.normalizeCommand(sqlCommand);
        assertEquals(select.interpret(sqlCommand), false);
    }
