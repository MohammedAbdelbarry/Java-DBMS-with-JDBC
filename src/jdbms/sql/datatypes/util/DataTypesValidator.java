...
public class DataTypesValidator {
     ...
     * @param dataType The name of the SQL Data Type.
     * @param value    The value to be checked.
     * @return True if the Value is a valid SQL value of the given data type,
     * false otherwise.
     */
     ...
     * not.
     * @param first  The first value to be checked.
     * @param second The second value to be checked.
     * @return True if the two given SQL values are of the same SQL Data Type
     * and false otherwise.
     */
     ...
     * @return The data type of the given SQL value.
     */
     ...
     * @param value The SQL value to be checked.
     * @return true if the value is a valid SQL value, and false otherwise
     */
     ...
     * @return true if this data type is supported and false otherwise
     */
