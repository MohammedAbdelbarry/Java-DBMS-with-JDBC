...
public class SelectQueryOutput {
     ...
     * columns.
     * @param columns The names of the selected columns.
     */
     ...
     * query.
     * @param distinct The distinct state of the query
     */
     ...
     * the query.
     * @param rows the rows selected by the query.
     */
     ...
     * is empty or not.
     * @return True if the select query output is empty and false otherwise.
     */
