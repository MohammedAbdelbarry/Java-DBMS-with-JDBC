 ...
 * @version $Id: ComparatorChain.html  5-11-14 15:01:49Z tn $
 * @since 2.0
 */
public class ComparatorChain<E> implements Comparator<E>, Serializable {
     ...
     */
    public ComparatorChain(final Comparator<E> comparator, final boolean
            reverse) {
     ...
     */
    public void addComparator(final Comparator<E> comparator, final boolean
            reverse) {
        checkLocked();
    ...
    private void checkChainIntegrity() {
        if (comparatorChain.size() == 0) {
            throw new UnsupportedOperationException("ComparatorChains must "
                    + "contain at least one Comparator");
        }
    }
     ...
     * @return -1, 0, or 1
     * @throws UnsupportedOperationException if the ComparatorChain does not
     *                                       contain at least one Comparator
     */
    @Override
    public int compare(final E o1, final E o2) throws
        ...
        for (int comparatorIndex = 0; comparators.hasNext();
			 ++comparatorIndex) {
