...
public class Database {
     ...
     * @param newTableIdentifier the table identifier object
     * @param fileHandler        the filehandler that will write the table
     * @return the number of updated rows
     * @throws TableAlreadyExistsException  If a table with the same name
    ...
    /**
     * Adds a table to the database.
     * @param tableParameters The {@link TableCreationParameters} object
     * @param fileHandler     the filehandler that will write the table
     * @return the number of updated rows
     * @throws TableAlreadyExistsException  If a table with the same name
     *                                      already exists in the database
     ...
     * @param fileHandler The {@link FileHandler} object that will delete the
     *                    table from the disk
     * @return The number of updated rows
     * @throws TableNotFoundException       If a table with the same name does
     *                                      not exist in the database
     * @throws FailedToDeleteTableException If the file handler failed to
     * delete
     ...
     * @param deleteParameters The {@link DeletionParameters} specifying which
     *                         rows will be deleted
     * @param fileHandler      The {@link FileHandler} object that will read
     *                            the
     *                         table from the disk and write it back after it
     *                         has been edited
    ...
    public int deleteFromTable(final DeletionParameters deleteParameters,
        ...
        final Table activeTable = fileHandler.readTable(databaseName
                        .toUpperCase(),
     ...
     * @param insertParameters The {@link InsertionParameters} Specifying the
     ...
     * a table.
     * @param selectParameters The {@link SelectionParameters} specifying which
     *                         rows and columns will be selected
     * @param fileHandler      The {@link FileHandler} object that will read
     *                            the
     *                         table from the disk and write it back after it
     *                         has been edited
     ...
     * @param updateParameters The {@link UpdatingParameters} specifying the
     *                         rows to be updated and the value to be assigned
     * @param fileHandler      The {@link FileHandler} object that will read
     *                            the
     *                         table from the disk and write it back after it
     *                         has been edited
     ...
     * @param parameters  The {@link AddColumnParameters} specifying the added
     *                    columns
     * @param fileHandler The {@link FileHandler} object that will read the
     *                    table from the disk and write it back after it has
     *                    been edited
     * @return The number of updated rows
     * @throws ColumnNotFoundException      When a column does not exist in the
     *                                      table
     ...
     * @param parameters  The {@link DropColumnParameters} specifying which
