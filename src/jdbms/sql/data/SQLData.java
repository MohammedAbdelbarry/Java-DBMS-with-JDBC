...
public class SQLData {
    ...
    /**
     * Constructs a new SQLData.
     * @param fileType The Back-End parser type
     ...
     * @param useParameters The parameters of the sql use statement
     * @return The number of updates
     * @throws TableAlreadyExistsException If a table with the same name already
     *                                     exists in the database
     * @throws DatabaseNotFoundException   If the database to be deleted was not
     *                                     found
     */
     ...
     * @param createDBParameters The parameters of the sql create statement
     * @return The Number of updates
     ...
     * @param DatabaseDroppingParameters The {@link DatabaseDroppingParameters}
     * @return The number of updates
     * @throws DatabaseNotFoundException       If the database to be deleted was
     *                                         not found
     * @throws FailedToDeleteDatabaseException If the {@link FileHandler} failed
     *                                         to delete the database
     * @throws FailedToDeleteTableException    If the {@link FileHandler} failed
     *                                         to delete a table in the
     *                                         database
     * @throws TableNotFoundException          If a table was not found in the
     *                                         database
     */
     ...
     * @param selectParameters the {@link SelectionParameters} object specifying
     ...
     * @throws TableNotFoundException       If a table with the same name does
     ...
     *                                      wrong
     * @throws IOException                  If the file handler failed to write
     ...
     * @throws ValueListTooLargeException   If the value list was too large when
     *                                      loading the table
     * @throws ValueListTooSmallException   If the value list was too small when
     *                                      loading the table
     ...
     * @throws TableAlreadyExistsException  If a table already exists in the
     ...
     * @param tableParameters the table dropping parameters
     * @return The number of updated rows
     * @throws TableNotFoundException       If the table to be dropped was not
     *                                      found
     * @throws FailedToDeleteTableException If the {@link FileHandler} failed to
     *                                      delete the table
     ...
     * @param parameters The {@link InsertionParameters} specifying the inserted
     *                   rows
     ...
     * @see Table#deleteRows(jdbms.sql.parsing.expressions.math
     * .BooleanExpression)
     */
     ...
     * @param parameters the column addition parameters
     * @return The number of updated rows
     * @throws ColumnNotFoundException      When a column does not exist in the
     *                                      table
     * @throws TypeMismatchException        When the user tries to compare a
     ...
     * @throws ValueListTooSmallException   If the value list was too small when
     *                                      loading the table
     * @throws AllColumnsDroppingException  If The user tries to drop all the
     *                                      columns in a table
