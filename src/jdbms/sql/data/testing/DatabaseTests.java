...
public class DatabaseTests {
    ...
    public void test1CreateDatabase() {
        try {
            final DatabaseCreationParameters createDBParameters = new
    ...
    public void test5InsertInto() {
        try {
            ...
            data.insertInto(getInsertionParameters("Students"));
        } catch (ColumnAlreadyExistsException | RepeatedColumnException |
                ...
                InvalidDateFormatException | IOException e) {
            e.printStackTrace();
    ...
    public void test6SelectFrom() {
        try {
            setActiveDatabase("college");
            final SelectQueryOutput output = data.selectFrom
                    (getSelectionParameters("Students"));
        ...
        } catch (ColumnNotFoundException | TypeMismatchException |
    ...
    public void test7AddTableColumn() {
        try {
            ...
            parameters.setColumnIdentifier(new ColumnIdentifier("Grade",
                    "INTEGER"));
            parameters.setTableName("Students");
            data.addTableColumn(parameters);
        } catch (ColumnAlreadyExistsException | TableNotFoundException |
    ...
    public void test8AddInvalidTableColumn() {
        try {
            setActiveDatabase("college");
            final AddColumnParameters parameters = new AddColumnParameters();
            parameters.setColumnIdentifier(new ColumnIdentifier("Invalid",
                    "X"));
            parameters.setTableName("Students");
            data.addTableColumn(parameters);
    ...
    public void test9F_DeleteFrom() {
        //		try {
        //			setActiveDatabase("college");
        //			DeletionParameters deleteParameters = new
        // DeletionParameters();
        //			deleteParameters.setTableName("Students");
        //			InputParametersContainer parameter = new
        // InputParametersContainer();
        //			parameter.setTableName("Students");
        //			BooleanExpression condition = new EqualsExpression
        // (parameter);
    ...
    public void test9G_DropTable() {
        setActiveDatabase("college");
        final TableDroppingParameters tableParameters = new
                TableDroppingParameters();
    ...
    public void testDropDatabase() {
        try {
            final DatabaseDroppingParameters dropDBParameters = new
                    DatabaseDroppingParameters();
            dropDBParameters.setDatabaseName("college");
            data.dropDatabase(dropDBParameters);
        } catch (DatabaseNotFoundException | FailedToDeleteDatabaseException
                | TableNotFoundException
