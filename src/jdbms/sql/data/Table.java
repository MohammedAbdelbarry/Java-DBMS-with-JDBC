...
public class Table {
     ...
     * @param createTableParameters the table creation parameters
     * @throws ColumnAlreadyExistsException When a column is inserted more than
     *                                      once
     * @throws InvalidDateFormatException   When a date value is wrong
     */
     ...
     * @throws InvalidDateFormatException   When a date value is wrong
     */
    public int addTableColumn(final String columnName, final String
            columnDataType)
            throws ColumnAlreadyExistsException, InvalidDateFormatException {
        if (tableColumns.containsKey(columnName.toUpperCase())) {
            throw new ColumnAlreadyExistsException(columnName);
        }
        final TableColumn newColumn = new TableColumn(columnName,
                columnDataType);
     ...
     * @param parameters the {@link DropColumnParameters} specifying the columns
     *                   to be dropped
     * @throws ColumnNotFoundException     When a column does not exist in the
     *                                     table
     * @throws AllColumnsDroppingException When a user tries to drop all the
     *                                     columns in a table
     * @throws RepeatedColumnException     When a user tries to drop the same
     *                                     column twice
     * @throws ColumnListTooLargeException When the column list is larger than
     ...
     * @throws RepeatedColumnException     When the column list contains
     *                                     duplicate columns
     * @throws ColumnListTooLargeException When the column list is larger than
     *                                     the number of columns in the table
     * @throws ColumnNotFoundException     When a column does not exist in the
     *                                     table
     * @throws ValueListTooLargeException  When the value list is larger than
     *                                     the number of columns in the table
     * @throws ValueListTooSmallException  When the value list is smaller than
     *                                     the column list
     * @throws TypeMismatchException       When the user tries to insert a value
     *                                     into a column of the wrong type
     * @throws InvalidDateFormatException  When the user tries to insert an
     *                                     invalid date value
     */
     ...
     * @throws ValueListTooLargeException When the value list is larger than the
    ...
    /**
     * Inserts a row.
     * @param columnNames the columns in which the values will get inserted
     * @param values      the values
     * @param nullCells   the columns to be filled with null
     * @throws RepeatedColumnException     When the column list contains
     *                                     duplicate columns
     * @throws ColumnListTooLargeException When the column list is larger than
     *                                     the number of columns in the table
    ...
    private void insertRow(final ArrayList<String> columnNames,
                           final ArrayList<String> values, final Set<String>
                                   nullCells)
            throws RepeatedColumnException,
            ColumnListTooLargeException,
     ...
     * @return the map representing the table columns
     */
     ...
     * @param selectParameters the parameters of the select statement
     * @return the select output
     * @throws ColumnNotFoundException    When a column does not exist in the
     *                                    table
     * @throws TypeMismatchException      When the user tries to compare a value
     *                                    to a value of the wrong type
     * @throws InvalidDateFormatException When the user tries to compare using
     *                                    an invalid date value
     */
    public SelectQueryOutput selectFromTable(final SelectionParameters
                                                     selectParameters) throws
            ColumnNotFoundException,
            TypeMismatchException, InvalidDateFormatException {
        ...
        final ArrayList<ArrayList<SQLType<?>>> tableRows = getTableRows
                (matches);
     ...
     * @param updateParameters the update statement parameters
     * @throws ColumnNotFoundException    When a column does not exist in the
     *                                    table
     * @throws TypeMismatchException      When the user tries to compare a value
     *                                    to a value of the wrong type
     ...
     * @param matches    the rows matching the condition of the assignment
     * @throws ColumnNotFoundException    When a column does not exist in the
     *                                    table
     * @throws TypeMismatchException      When the user tries to compare a value
     *                                    to a value of the wrong type
    ...
    private void AssignColumn(final AssignmentExpression assignment,
                              final ArrayList<Integer> matches) throws
            ColumnNotFoundException,
            TypeMismatchException, InvalidDateFormatException {
     ...
     * in this table.
     * @return a list of all the names of the columns in this table
     */
     ...
     * @param condition         the boolean condition
     * @param conditionColumn   the column of the condition
     * @param other             the value compared to the column
     * @param leftIsTableColumn specifies if the left hand side of the
     *                          expression is a column or a value
     * @return
     * @throws InvalidDateFormatException When the user tries to compare using
     *                                    an invalid date value
     */
    ...
    /**
     * @param condition  the boolean condition
     * @param leftValue  The value of the left-hand side of the comparison
     * @param rightValue The value of the right-hand side of the comparison
     * @return The comparison boolean output
     * @throws InvalidDateFormatException When the user tries to compare using
     *                                    an invalid date value
     */
    private boolean evaluateExpression(final BooleanExpression condition,
                                       final String leftValue, final String
                                               rightValue)
     ...
     * @param order         The comparison column and the order of the
     *                      comparison
     * @param columnIndices the indices of the columns
     ...
     */
    private ArrayList<ArrayList<SQLType<?>>> getTableRows(final
                                                          ArrayList<Integer>
                                                                  matches) {
