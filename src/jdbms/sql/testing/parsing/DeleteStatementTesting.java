...
public class DeleteStatementTesting {
    ...
    public void testDeleteConditional() {
        ...
        assertEquals(delete.interpret(sqlCommand), true);
        assertEquals(name, delete.getParameters().getTableName());
        assertEquals("name", delete.getParameters().getCondition()
                .getLeftOperand());
        assertEquals("'x y'", delete.getParameters().getCondition()
                .getRightOperand());
    }
    ...
    public void testFloatDeleteConditional() {
        ...
        assertEquals(delete.interpret(sqlCommand), true);
        assertEquals(name, delete.getParameters().getTableName());
        assertEquals("grade", delete.getParameters().getCondition()
                .getLeftOperand());
        assertEquals("5.6584", delete.getParameters().getCondition()
                .getRightOperand());
    }
