...
public class ProtocolBufferReader implements TableReader {
     ...
     *                                      table
     * @throws InvalidDateFormatException   the date format was invalid
     * @throws RepeatedColumnException      the column was repeated
     * @throws ColumnListTooLargeException  the column list was larger than the
     *                                      value list
     * @throws ColumnNotFoundException      the column wasn't found in the
     *                                      table
     * @throws ValueListTooLargeException   the value list was larger than the
     *                                      column list
     * @throws ValueListTooSmallException   the value list was smaller than the
     *                                      column list
     * @throws TypeMismatchException        the type of the value being inserted
    ...
    private Table createTableObject(final DBTable protoTable)
        ...
        final ArrayList<ColumnIdentifier> columnsDefinitions = new
                ArrayList<>();
