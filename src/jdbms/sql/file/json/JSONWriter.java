...
public class JSONWriter implements FileWriter {
	...
	public static void main(final String[] args) throws ColumnAlreadyExistsException, InvalidDateFormatException, RepeatedColumnException, ColumnListTooLargeException, ColumnNotFoundException, ValueListTooLargeException, ValueListTooSmallException, TypeMismatchException, IOException {
		...
		obj.create(table, "OOO","");
		final JSONReader reader = new JSONReader();
		final Table newTable = reader.parse(table.getName(), "OOO", "");
