...
public class FileHandler {
	 ...
	 * @throws FileFormatNotSupportedException If the
	 * type of the back-end parser was not supported
	 */
	 ...
	 * @throws DatabaseNotFoundException If the
	 * database was not found on the disk
	 * @throws FailedToDeleteDatabaseException If
	 * the database couldn't be deleted
	 * @throws TableNotFoundException If a table in the
	 * database couldn't be found
	 * @throws FailedToDeleteTableException If a table
	 * in the database couldn't be deleted
	 */
	 ...
	 * @param databaseName The name of the database
	 * @throws TableNotFoundException If the
	 * table to be deleted couldn't be found
	 * @throws FailedToDeleteTableException If the table
	 * couldn't be deleted
	 */
	 ...
	 * and returns it.
	 * @param databaseName The name of the
	 * database to be loaded
	 * @return The loaded {@link Database}
	 * @throws DatabaseNotFoundException If the database
	 * to be loaded was not found
	 * @throws TableAlreadyExistsException If the database
	 * has repeated tables
	 */
	 ...
	 * @throws DatabaseAlreadyExistsException If the
	 * database already exists on the disk
	 */
	 ...
	 * @param tempName The name of the temporary
	 * database
	 ...
	 * @param databaseName The name of the database
	 * @throws IOException If the table could not
	 * be written
	 */
	 ...
	 * was repeated while inserting to the table
	 * @throws ColumnListTooLargeException If the
	 * column list was too large while inserting to
	 * the table
	 * @throws ColumnNotFoundException If a column
	 * could not be found while inserting to the table
	 * @throws ValueListTooLargeException If the value list
	 * was too large while inserting to the table
	 * @throws ValueListTooSmallException If the value list
	 * was too small while inserting to the table
	 * @throws TypeMismatchException If the parser
	 * tried inserting a value into a column of the
	 * wrong type
	 * @throws InvalidDateFormatException If the values
	 * contained an invalid date
	 * @throws IOException If the parser couldn't read
