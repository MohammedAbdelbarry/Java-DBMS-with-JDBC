...
public class JDBCTests {
        ...
        try {
            ...
            count = statement.executeUpdate(
                    "INSERT INTO Student"
                            + " (ID, Name, Grade)"
                            + " VALUES (2 ,"
                            + "'Ahmed El Naggar', 90.2)");
            Assert.assertEquals("Table"
                            + " Insertion did not return 1",
                    1, count);
            count = statement.executeUpdate("INSERT"
                    + " INTO Student"
                    + " (ID, Name, Grade)"
    ...
    public void testMetaData() throws SQLException {
        ...
        try {
            ...
            Assert.assertEquals("Invalid Result"
                    + " Set Size", 2, rows);
            Assert.assertEquals(Types.DATE,
                    resultSet.
                            getMetaData().
                            getColumnType(resultSet.
                                    findColumn("BirTh")));
            Assert.assertEquals(Types.FLOAT,
                    resultSet.
                            getMetaData().
                            getColumnType(resultSet.
                                    findColumn("gRAdE")));
        ...
        try {
            ...
            final ResultSet resultSet = statement.
                    executeQuery("select biRth, gRAde,"
                            ...
                            + " > '0001-01-01 01:01:01'"
                            + " order by"
                            + " currenttime, grade desc");
            resultSet.first();
            Assert.assertEquals(resultSet.
                    getString(4), "hello");
            Assert.assertEquals(resultSet.
                    getFloat(2), -0.366, 0.001);
            resultSet.next();
            Assert.assertEquals(resultSet.
                            getString("name"),
                    "A spaced string");
    ...
    public void testBigInt() throws SQLException {
        final Connection connection
                = createUseDatabase("testingDb");
        try {
            final Statement statement
                    = connection.createStatement();
            statement.execute("create taBlE myT"
                    + " (a bigint,"
                    + " b text, c date,"
                    + " d datetime, e double)");
            int count = statement.executeUpdate("insert into"
                    + " myT values (1000000000000,"
                    + " 'hello', '2012-12-16',"
                    + " '2012-12-16 10:02:06',"
                    + " -62.60)");
            Assert.assertEquals("Table Insertion"
            ...
            count = statement.executeUpdate("insert"
                    ...
                    + " '2012-12-16 10:04:06',"
                    + " 62.60), (10, 'oom',"
                    + " '2010-10-10', '2011-11-17"
                    + " 10:06:03', 6.33)");
            Assert.assertEquals("Table"
                    + " Insertion did "
                    + "not return 2", 2, count);
            final ResultSet resultSet = statement.
                    executeQuery("select e, b, d,"
                            + " a, c from myt"
                            + " where e != -100.4"
                            + " order by c, e desc");
            int rowsNumber = 0;
            ...
            resultSet.first();
            Assert.assertEquals(6.33, resultSet.
                    getDouble(1), 0.0001);
            Assert.assertEquals("oom", resultSet.
                    getString(2));
            ...
            Assert.assertEquals(Timestamp.valueOf(
                    "2011-11-17 10:06:03"),
                    resultSet.getTimestamp(resultSet.
                            findColumn("d")));
            Assert.assertEquals(Date.valueOf(
                    "2010-10-10"),
                    resultSet.getDate(resultSet.
                            findColumn("c")));
        } catch (final SQLException e) {
            e.printStackTrace();
            fail("SQL Exception.");
    ...
    public void testCreateTable() throws SQLException {
        ...
        try {
            final Statement statement = connection.createStatement();
            statement.execute("CREATE TABLE"
                    + " table_name1(column_name1 varchar,"
                    + " column_name2 int,"
                    + " column_name3 date)");
            statement.close();
        } catch (final Throwable e) {
        ...
        try {
            ...
            statement.execute("CREATE TABLE"
                    ...
                    + " column_name3 date)");
            Assert.fail("Created existing table"
                    + " successfully!");
        } catch (final SQLException e) {
        ...
        try {
            ...
            statement.execute("CREATE"
                    + " TABLE incomplete_table_name1");
            Assert.fail("Create invalid"
                    + " table succeed");
        } catch (final SQLException e) {
        } catch (final Throwable e) {
            e.printStackTrace();
    ...
    public void testInsertWithoutColumnNames()
        ...
        try {
            final Statement statement
                    = connection.createStatement();
            statement.execute("CREATE TABLE"
                    + " table_name3(column_name1 varchar,"
                    + " column_name2 int,"
                    + " column_name3 float)");
            final int count = statement.executeUpdate(
                    "INSERT INTO table_name3"
                            + " VALUES ('value1', 3, 1.3)");
            Assert.assertEquals("Insert returned"
                    + " a number != 1", 1, count);
            statement.close();
        } catch (final Throwable e) {
            fail("SQL Exception");
    ...
    public void testInsertWithColumnNames() throws SQLException {
        ...
        try {
            final Statement statement
                    = connection.createStatement();
            statement.execute("CREATE TABLE"
                    + " table_name4(column_name1"
                    + " varchar, column_name2 int,"
                    + " column_name3 date)");
            final int count = statement.executeUpdate(
                    "INSERT INTO table_name4(column_NAME1,"
                            + " COLUMN_name3, column_name2)"
    ...
    public void testInsertWithWrongColumnNames()
        ...
        try {
            final Statement statement
                    = connection.createStatement();
            statement.execute("CREATE TABLE"
                    + " table_name5(column_name1"
                    + " varchar, column_name2 int,"
                    + " column_name3 varchar)");
            statement.executeUpdate(
                    "INSERT INTO table_name5("
                            + "invalid_column_name1,"
                            + " column_name3, column_name2)"
    ...
    public void testUpdate() throws SQLException {
        ...
        try {
            final Statement statement
                    = connection.createStatement();
            statement.execute("CREATE TABLE "
                    + "table_name7(column_name1"
                    + " varchar, column_name2 int,"
                    + " column_name3 varchar)");
            final int count1 = statement.executeUpdate(
                    "INSERT INTO table_name7("
            ...
            final int count2 = statement.executeUpdate(
                    "INSERT INTO table_name7(column_NAME1,"
                            + " COLUMN_name3, column_name2)"
                            + " VALUES ('value1', 'value3', 4)");
            Assert.assertEquals("Insert returned"
                    + " a number != 1", 1, count2);
            ...
            Assert.assertEquals("Insert returned"
                    + " a number != 1", 1, count3);
            final int count4 = statement.executeUpdate(
                    "UPDATE table_name7 SET column_name1"
                            + "='1111111111', COLUMN_NAME2"
                            + "=2222222, column_name3"
                            + "='333333333'");
    ...
    public void testConditionalUpdate()
        ...
        try {
            ...
            statement.execute(
                    "CREATE TABLE"
                            + " table_name8(column_name1"
                            + " varchar, column_name2 int,"
                            + " column_name3 date,"
                            + " column_name4 float)");

            final int count1 = statement.executeUpdate(
                    "INSERT INTO table_name8("
                            + "column_NAME1, COLUMN_name3,"
                            + " column_name2, column_name4)"
                            + " VALUES ('value1',"
                            + " '2011-01-25', 3, 1.3)");
            Assert.assertEquals("Insert returned"
                    + " a number != 1", 1, count1);
    ...
    public void testUpdateEmptyOrInvalidTable() throws SQLException {
        ...
        try {
            ...
            final int count = statement.executeUpdate(
                    "UPDATE table_name9"
                            ...
                            + " column_name2=15,"
                            + " column_name3='value2'");
            Assert.assertEquals("Updated empty table"
                            + " retruned non-zero count!",
                    0, count);
            statement.close();
        } catch (final Throwable e) {
            fail("SQL Exception");
        ...
        try {
            final Statement statement
                    = connection.createStatement();
            statement.executeUpdate(
                    "UPDATE wrong_table_name9"
                            + " SET column_name1='value1',"
                            + " column_name2=15,"
                            + " column_name3='value2'");
            Assert.fail("Updated empty table"
                    + " retruned non-zero count!");
            statement.close();
        } catch (final SQLException e) {
        } catch (final Throwable e) {
    ...
    public void testDelete() throws SQLException {
        ...
        try {
            final Statement statement
                    = connection.createStatement();
            statement.execute("CREATE TABLE"
                    + " table_name10(column_name1"
                    + " varchar, column_name2 int,"
                    + " column_name3 date)");
            final int count1 = statement.executeUpdate(
                    "INSERT INTO table_name10("
                            + "column_NAME1, COLUMN_name3,"
                            + " column_name2) VALUES ('value1'"
                            + ", '2011-01-25', 4)");
            Assert.assertEquals("Insert returned a"
                    + " number != 1", 1, count1);
            final int count2 = statement.executeUpdate(
                    "INSERT INTO table_name10("
                            + "column_NAME1, COLUMN_name3,"
    ...
    public void testConditionalDelete() throws SQLException {
        ...
        try {
            final Statement statement
                    = connection.createStatement();
            statement.execute("CREATE TABLE "
                    + "table_name11(column_name1"
                    + " varchar, column_name2 int"
                    + ", column_name3 DATE)");
            final int count1 = statement.executeUpdate(
                    "INSERT INTO table_name11("
                            + "column_NAME1, COLUMN_name3,"
                            + " column_name2) VALUES ("
                            + "'value1', '2011-01-25',"
                            + " 4)");
            ...
            Assert.assertEquals("Insert"
                    + " returned a number != 1", 1, count3);
            final int count4
                    = statement.executeUpdate(
                    "DELETE From table_name11"
                            + "  WHERE coLUmn_NAME3>"
                            + "'2011-01-25'");
            Assert.assertEquals("Delete"
                            + " returned wrong"
        ...
        try {
            ...
            statement
                    .execute("CREATE TABLE "
                            + "table_name12(column_name1"
                            + " varchar, column_name2 int,"
                            + " column_name3 varchar)");
            final int count1 = statement.executeUpdate(
                    "INSERT INTO table_name12"
                            + "(column_NAME1, COLUMN_name3,"
                            + " column_name2) VALUES "
                            + "('value1', 'value3',"
                            + " 4)");
    ...
    public void testConditionalSelect() throws SQLException {
        ...
        try {
            ...
            Assert.assertEquals("Wrong"
                            + " number of rows",
                    2, rows);
            Assert.assertEquals("Wrong number"
                            + " of columns",
        ...
        try {
            ...
            final boolean result1 = statement.execute(
                    "INSERT INTO table_name13"
                            ...
                            + " VALUES ('value1',"
                            + " 8, 'value3')");
            Assert.assertFalse("Wrong return"
                            + " from 'execute'"
                            + " for insert"
                            + " record",
                    result1);
    ...
    public void testOrderBy()
        ...
        try {
            ...
            res2.next();
            Assert.assertEquals("Wrong order"
                            + " of rows",
                    4, res2.getInt(
                            "column_name2"));
            Assert.assertEquals("Wrong order"
